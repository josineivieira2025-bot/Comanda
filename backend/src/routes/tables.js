...
router.get('/', permit('tables.view', 'dashboard.view', 'orders.view', 'orders.edit'), asyncHandler(async (req, res) => {
...
router.put('/:id', permit('tables.edit'), asyncHandler(async (req, res) => {
...
router.delete('/:id', permit('tables.edit'), asyncHandler(async (req, res) => {
...
router.post('/:id/open', permit('orders.edit'), asyncHandler(async (req, res) => {

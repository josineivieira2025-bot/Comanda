...
export default function Inventory() {
  const { data, mutate, remove, moveStock } = useApp();
  ...
  return <>
    <PageHeader title="Estoque"><button className="primary" onClick={() => open()}><Plus /> Cadastrar produto</button></PageHeader>

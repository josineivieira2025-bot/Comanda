...
export default function Customers() {
  const { data, mutate, remove, orderTotal, notify, can } = useApp();
  ...
  return <>
    <PageHeader title="Clientes" description="Cadastro, frequência e histórico de consumo.">{can('customers.edit') && <button className="primary" onClick={() => open()}><Plus /> Novo cliente</button>}</PageHeader>

...
export default function Tables() {
  const { data, mutate, remove, tableTotal, openTable, resolveCall } = useApp();
  ...
  async function toggle(table) { if (table.status === 'available') await openTable(table.id); else navigate('/financeiro'); }
